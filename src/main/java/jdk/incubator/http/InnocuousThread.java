 ...
 */
final class InnocuousThread extends Thread {
    ...
    private InnocuousThread(ThreadGroup group, Runnable target, String name, ClassLoader tccl) {
        ...
        U.putOrderedObject(this, INHERITABLE_THREAD_LOCALS, null);
        U.putOrderedObject(this, INHERITEDACCESSCONTROLCONTEXT, ACC);
        U.putOrderedObject(this, CONTEXTCLASSLOADER, tccl);
    }
    ...
    public final void eraseThreadLocals() {
        U.putObject(this, THREAD_LOCALS, null);
        U.putObject(this, INHERITABLE_THREAD_LOCALS, null);
    }
    ...
    static {
        try {
            ...
            THREAD_LOCALS = U.objectFieldOffset(tk.getDeclaredField("threadLocals"));
            INHERITABLE_THREAD_LOCALS = U.objectFieldOffset
                    (tk.getDeclaredField("inheritableThreadLocals"));
            INHERITEDACCESSCONTROLCONTEXT = U.objectFieldOffset
                (tk.getDeclaredField("inheritedAccessControlContext"));
            CONTEXTCLASSLOADER = U.objectFieldOffset
