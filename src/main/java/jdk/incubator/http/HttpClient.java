...
public abstract class HttpClient {
     ...
     *
     * <p><b>Implementation Note:</b><br> The system-wide default values are retrieved at the time the
    ...
    public abstract static class Builder {
         ...
         *
         * <p><b>Implementation Note:</b><br> If a security manager has been installed, the thread
         ...
         *
         * <p><b>API Note:</b><br> {@code ProxySelector.of(InetSocketAddress)}
         ...
         * returned by {@code ProxySelector.of(InetSocketAddress)},
     ...
     *
     * <p><b>Implementation Requirements:</b><br> The default implementation of this method throws
     ...
     *
     * <p><b>Implementation Note:</b><br> Both builder and {@code WebSocket}s created with it operate in
