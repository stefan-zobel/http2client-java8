 ...
 * {@code Listener}.
 *
 * <p><b>Implementation Requirements:</b><br> Methods of {@code WebSocket} are failure-atomic in respect to
...
public interface WebSocket {
    ...
    interface Listener {
         ...
         *
         * <p><b>Implementation Requirements:</b><br> The default implementation of this method behaves as if:
         *
         * <pre>{@code
         *     webSocket.request(1);
         * }</pre>
         ...
         * }</pre>
         *
         * <p><b>Implementation Note:</b><br> This method is always invoked with character sequences
     ...
     * </ul>
     *
     * <p><b>Implementation Note:</b><br> If a partial UTF-16 sequence is passed to this method, a
     ...
     * </ul>
     *
     * <p><b>Implementation Requirements:</b><br> An endpoint sending a Close message might not receive a
     ...
     * have no effect.
     *
     * <p><b>API Note:</b><br> Depending on its implementation, the state (for example, whether
