...
public final class SequentialScheduler {
     ...
     *
     * <p><b>API Note:</b><br> {@code DeferredCompleter} is useful when a task is not necessary
     ...
     *
     * <p><b>Implementation Requirements:</b><br> The recursion which is possible here must be bounded:
     *
     *  <pre>{@code
     *     this.runOrSchedule()
     *         completer.complete()
     ...
     * }</pre>
     *
     * <p><b>Implementation Note:</b><br> The recursion in this implementation has the maximum
     * depth of 1.
     */
     ...
     *         to be executed.
     *
     * <p><b>API Note:</b><br> The given executor can be {@code null} in which case calling
