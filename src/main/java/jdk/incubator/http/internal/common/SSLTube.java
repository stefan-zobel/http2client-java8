...
public class SSLTube implements FlowTube {
    ...
    private final SSLEngineEx engine;
    private volatile boolean finished;

    public SSLTube(SSLEngineEx engine, Executor executor, FlowTube tube) {
    ...
    final class SSLTubeFlowDelegate extends SSLFlowDelegate {
        SSLTubeFlowDelegate(SSLEngineEx engine, Executor executor,
