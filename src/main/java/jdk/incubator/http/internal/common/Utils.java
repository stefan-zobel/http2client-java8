...
//    }
    ...
    private static final Set<String> DISALLOWED_HEADERS_SET = Sets.of(
     ...
     */
    public static SysLogger getDebugLogger(Supplier<String> dbgTag) {
     ...
     * {@code <Level>:[<thread-name>] [<elapsed-time>] <dbgTag>: <formatted message>}
     *
     * <p><b>API Note:</b><br> To obtain a logger that will always print things on stderr in
     ...
     * @return A logger for HTTP internal debug traces
     */
    static SysLogger getDebugLogger(Supplier<String> dbgTag, SysLogger.Level errLevel) {
        return DebugLogger.createHttpLogger(dbgTag, SysLogger.Level.OFF, errLevel);
    }
     ...
     * @return A logger for HTTP internal debug traces
     */
    public static SysLogger getDebugLogger(Supplier<String> dbgTag, boolean on) {
        SysLogger.Level errLevel = on ? SysLogger.Level.ALL : SysLogger.Level.OFF;
     ...
     * {@code <Level>:[<thread-name>] [<elapsed-time>] <dbgTag>: <formatted message>}
     *
     * <p><b>API Note:</b><br> To obtain a logger that will always print things on stdout in
     *          addition to forwarding to the internal logger, use
     ...
     */
    public static SysLogger getHpackLogger(Supplier<String> dbgTag, SysLogger.Level outLevel) {
        SysLogger.Level errLevel = SysLogger.Level.OFF;
     ...
     * @return A logger for HPACK internal debug traces
     */
    public static SysLogger getHpackLogger(Supplier<String> dbgTag, boolean on) {
        SysLogger.Level outLevel = on ? SysLogger.Level.ALL : SysLogger.Level.OFF;
