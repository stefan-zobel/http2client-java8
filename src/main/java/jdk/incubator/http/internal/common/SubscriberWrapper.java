 ...
 * <p>
 * Each SubscriberWrapper has a {@link java9.util.concurrent.CompletableFuture}{@code <Void>}
                ...
                // TODO: SSLTube Subscriber will never change? Does this really need to be a TS?
{
     ...
     * #onNext(List)} the given filter function is invoked
     ...
     * {@link #onNext(List)} the incoming() method is called.
     *
    ...
    public void outgoing(ByteBuffer buffer, boolean complete) {
        ...
        outgoing(Lists.of(buffer), complete);
    }
    ...
    public void addData(ByteBuffer l) {
        ...
        incomingCaller(Lists.of(l), false);
    }
