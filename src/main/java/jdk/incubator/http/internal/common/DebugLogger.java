 ...
 */
class DebugLogger implements SysLogger {
    ...
    final static SysLogger HTTP = SysLogger.getLogger(HTTP_NAME);
    final static SysLogger HPACK = SysLogger.getLogger(HPACK_NAME);
     ...
     */
    private DebugLogger(SysLogger logger,
