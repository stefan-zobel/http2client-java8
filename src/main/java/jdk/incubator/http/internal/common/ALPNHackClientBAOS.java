...
/**
 * Super hacky class that allows the client and server hello message to be
 * modified and the corresponding hash generated at runtime.
 *
 * @author Stuart Douglas
 */
final class ALPNHackClientBAOS extends ByteArrayOutputStream {
    ...
    ALPNHackClientBAOS(SSLEngine sslEngine) {
