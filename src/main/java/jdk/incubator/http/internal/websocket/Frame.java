...
final class Frame {
    ...
    static final class Masker {
        ...
        Masker mask(int value) {
            ((ByteBuffer) acc.clear()).putInt(value).putInt(value).flip();
            ...
            while (true) {
                ...
                switch (state) {
                    ...
                    case READING_16_LENGTH:
                        ...
                        remainingPayloadLength = ((ByteBuffer) accumulator.flip()).getChar();
                    ...
                    case READING_64_LENGTH:
                        ...
                        remainingPayloadLength = ((ByteBuffer) accumulator.flip()).getLong();
                    ...
                    case READING_MASK:
                        ...
                        consumer.maskingKey(((ByteBuffer) accumulator.flip()).getInt());
                        accumulator.clear();
