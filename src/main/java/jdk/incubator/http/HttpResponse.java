...
import java9.util.concurrent.Flow.Subscriber;
 ...
 * <br><a href="http://openjdk.java.net/jeps/11"><b>Incubating Feature</b>.</a> <b>Will be removed in a future release.</b>
 *
...
public abstract class HttpResponse<T> {
    ...
    static class PathBodyHandler implements UntrustedBodyHandler<Path> {
        ...
        public BodySubscriber<Path> apply(int statusCode, HttpHeaders headers) {
            ResponseSubscribers.PathSubscriber bs = (ResponseSubscribers.PathSubscriber)
                  HttpResponse.asFileImpl(file, openOptions);
     ...
     * <li>{@link #buffering(HttpResponse.BodyHandler, int)
    ...
    public interface BodyHandler<T> {
         ...
         * BodySubscriber#fromSubscriber(Flow.Subscriber)}, with the given
         * {@code subscriber}.
         *
         ...
         * database, etc.
         *
         * <p><b>API Note:</b><br> This method can be used as an adapter between {@code
         ...
         * BodySubscriber#fromSubscriber(Flow.Subscriber, Function)}, with the
        ...
        public static BodyHandler<Path> asFile(Path file, OpenOption... openOptions) {
            ...
            List<OpenOption> opts = Lists.of(openOptions);
         ...
         *
         * <p><b>API Note:</b><br> See {@link BodySubscriber#asInputStream()} for more information.
         *
         * @return a response body handler
         */
         ...
         * BodySubscriber#buffering(HttpResponse.BodySubscriber,int) buffering BodySubscriber}
         ...
         * {@linkplain BodySubscriber#buffering(HttpResponse.BodySubscriber,int)
         ...
         *        BodySubscriber#buffering(HttpResponse.BodySubscriber,int) BodySubscriber.buffering}
     ...
     * <br><a href="http://openjdk.java.net/jeps/11"><b>Incubating Feature</b>.</a> <b>Will be removed in a future release.</b>
     *
     * <p> The object acts as a {@link java9.util.concurrent.Flow.Subscriber}&lt;{@link List}&lt;{@link
     ...
     * to consume the data.
     *
     * <p><b>API Note:</b><br> To ensure that all resources associated with the
     * corresponding exchange are properly released, an implementation
     * of {@code BodySubscriber} must ensure to {@linkplain
     * java9.util.concurrent.Flow.Subscription#request request} more data until
     * {@link #onComplete() onComplete} or {@link #onError(Throwable) onError}
     * are signalled, or {@linkplain java9.util.concurrent.Flow.Subscription#request cancel}
     * its {@linkplain #onSubscribe(java9.util.concurrent.Flow.Subscription) subscription}
    ...
    public interface BodySubscriber<T>
         ...
         * HttpResponse.BodyHandler) HttpClient::send} or {@link HttpClient#sendAsync(HttpRequest,
         * HttpResponse.BodyHandler) HttpClient::sendAsync} as appropriate.
         *
         * <p> The {@link HttpResponse} using this subscriber is available after
         * the entire response has been read.
         *
        ...
        public static BodySubscriber<Path> asFile(Path file, OpenOption... openOptions) {
            ...
            return HttpResponse.asFileImpl(file, openOptions);
        }
    ...
    public interface MultiSubscriber<U,T> {
         ...
         * HttpClient#sendAsync(HttpRequest, HttpResponse.MultiSubscriber)}. The
        ...
        /**
         * Returns a {@link java9.util.concurrent.CompletableFuture}{@code <U>}
         ...
         *
         * <p><b>Implementation Note:</b><br> Implementations might follow the pattern shown below
         * <pre>
         * {@code
