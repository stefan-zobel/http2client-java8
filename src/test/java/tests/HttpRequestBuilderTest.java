 ...
 * @test
 * @bug 8170064
 * @summary  HttpRequest[.Builder] API and behavior checks
 */
@Test
...
//        builder.build();
    ...
    @SafeVarargs
    static <R, P> R test1(String name, R receiver, Function<P, R> m, P arg,
                          Class<? extends Exception> ...ex) {
    ...
    @SafeVarargs
    static <R, P1, P2> R test2(String name, R receiver, BiFunction<P1, P2, R> m,
                               P1 arg1, P2 arg2,
                               Class<? extends Exception> ...ex) {
        try {
