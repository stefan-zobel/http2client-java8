...
public class TimeoutBasic {
    ...
    static List<Duration> TIMEOUTS = Lists.of(Duration.ofSeconds(1),
    ...
    static final List<String> SCHEMES = Lists.of("https", "http");
    ...
    private static void realmain(String[] args) throws Exception {
        for (Function<HttpRequest.Builder, HttpRequest.Builder> m : METHODS) {
            for (HttpClient.Version version : Lists.of(HttpClient.Version.HTTP_1_1)) {
    ...
    private static void test(HttpClient.Version version,
                             HttpClient.Version reqVersion,
                             String scheme,
                             Function<HttpRequest.Builder, HttpRequest.Builder> method,
                             ServerSocketFactory ssf)
