...
public class Http2TestServer implements AutoCloseable {
     ...
     * behavior is required, either direct control over the frames sent, "bad"
...
//        sslp.setApplicationProtocols(new String[]{"h2"}); // XXX
        sslp = SSLParametersExAccess.init(sslp, new String[] {"h2"}); // XXX this works on Java >= 9 only!
