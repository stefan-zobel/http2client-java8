...
public class TLSConnection {
        ...
        try (Http2TestServer server = new Http2TestServer("127.0.0.1", true, 0)) {
            ...
            success &= expectSuccess(
                    ...
                    () -> connect(uriString, new SSLParameters(
                            ...
                            new String[] { "TLSv1.2" }))); // XXX TLSv1.1 
            success &= checkProtocol(handler.getSSLSession(), "TLSv1.2"); // XXX TLSv1.1
            success &= checkCipherSuite(handler.getSSLSession(),
    ...
    private static String getKeystorePath() {
        ...
        if (ksPath != null) {
            ...
            ksPath = SameDirectory.getPackagePath(TLSConnection.class) + "/keystore.jks";
