...
//            SSLParameters p = serverContext.getSupportedSSLParameters(); // XXX unused
//            p.setApplicationProtocols(new String[]{"h2"}); // XXX unused
//            p = SSLParametersExAccess.init(p, new String[] {"h2"}); // XXX this works on Java >= 9 only!
