...
public class VersionTest {
    ...
    private static void test(HttpClient.Version version) throws Exception {
    ...
    static void initServer() throws Exception {
        ...
        HttpHandler h = new VersionTestHandler();
...
final class VersionTestHandler implements HttpHandler {
    int counter = 0;
