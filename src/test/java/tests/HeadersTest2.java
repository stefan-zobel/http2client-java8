...
public class HeadersTest2 {
    ...
    private static CompareTest test(boolean s, List<String> l1, List<String> l2) {
        return new CompareTest(s, l1, l2);
    }

    static CompareTest[] compareTests = new CompareTest[] {
        test(true, Lists.of("Dontent-length", "99"), Lists.of("dontent-length", "99")),
        test(false, Lists.of("Dontent-length", "99"), Lists.of("dontent-length", "100")),
        test(false, Lists.of("Name1", "val1", "Name1", "val2", "name1", "val3"),
                    Lists.of("Name1", "val1", "Name1", "val2")),
        test(true, Lists.of("Name1", "val1", "Name1", "val2", "name1", "val3"),
                   Lists.of("NaMe1", "val1", "NAme1", "val2", "name1", "val3"))
    };
