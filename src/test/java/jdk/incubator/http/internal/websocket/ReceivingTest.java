...
import static java9.util.concurrent.CompletableFuture.completedStage;
...
public class ReceivingTest {
    ...
    public void testNonPositiveRequest() throws Exception {
        ...
        assertEquals(invocations, Lists.of(onOpen(ws), onError(ws, IllegalArgumentException.class)));
    }
    ...
    public void testText1() throws Exception {
        ...
        listener.onCloseOrOnErrorCalled().get(10, TimeUnit.SECONDS);
        List<MockListener.ListenerInvocation> invocations = listener.invocations();
        assertEquals(invocations, Lists.of(onOpen(ws),
                                           onText(ws, "1", FIRST),
                                           onText(ws, "2", PART),
                                           onText(ws, "3", LAST),
